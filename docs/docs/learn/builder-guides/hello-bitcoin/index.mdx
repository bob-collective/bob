...
- Get Sepolia ETH and bridge them to BOB. Use the links on the [Connect to BOB](/docs/learn/user-guides/networks) page.
...
:::tip
If you want, you can also modify the contract at a later stage and use [other ERC20 contracts already deployed on BOB Sepolia (Testnet)](/docs/learn/reference/contracts).
:::
