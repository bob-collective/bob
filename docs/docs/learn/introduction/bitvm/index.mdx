...
- BOB's co-founder, Alexei Zamyatin, co-authored [the most comprehensive write-up of the BitVM2 design so far](/learn/reference/research#bitvm2-bridging-bitcoin-to-second-layers).
...
- [BitVM Official Implementation](https://github.com/BitVM/BitVM)
