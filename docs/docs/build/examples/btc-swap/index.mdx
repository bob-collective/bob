...
5. Follow the steps in the [using BOB guide](/docs/learn/introduction/use-bob.md) to add the BOB L2 testnet to your EVM wallet and fund it with ETH using the faucet.
