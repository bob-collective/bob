...
- [Sepolia ETH](https://docs.gobob.xyz/docs/learn/guides/#bob-testnet): this ETH needs to be bridge into BOB Testnet
- [Testnet BTC](https://docs.gobob.xyz/docs/learn/guides/#bitcoin-testnet)
- ERC20 tokens
- Ordinals

We also suggest that you create and fund two accounts (one for opening orders and another for filling orders), so you can through each flow by yourself.
...
5. Add BOB L2 testnet to your EVM wallet and fund it with ETH using [Conduit](https://app.conduit.xyz/published/view/puff-bob-jznbxtoq7h)
