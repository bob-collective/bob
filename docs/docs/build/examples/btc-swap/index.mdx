...
You can try the demo at [https://app.gobob.xyz/demo/p2p-swap](https://app.gobob.xyz/demo/p2p-swap).
...
5. Follow the steps in the [using BOB guide](/docs/learn/guides/index.md) to add the BOB L2 testnet to your EVM wallet and fund it with ETH using the faucet.
