...
You might be interested in verifying Bitcoin transactions on BOB. Checkout the [Bitcoin Light Client](/docs/build/components/relay.md) guide to learn more.

### Examples

Checkout a full smart contract and UI example that uses BOB to build a [Bitcoin P2P Marketplace](/docs/build/examples/btc_swap/).
