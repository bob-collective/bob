...
- Get Sepolia ETH and bridge them to BOB. [Check the guide](/docs/learn/guides/#bob-testnet).
...
`Note`: [Guide](https://support.metamask.io/hc/en-us/articles/360015289632-How-to-export-an-account-s-private-key) to export private key. The script also verifies the contract.
