...
- **Ethereum & BNB Smart Chain:** CCIP burns the source token and mints on the destination chain. On Ethereum and BSC, the total token supply is only the supply on that particular chain.
