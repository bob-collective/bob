...
- The contract allows swapping between BTC->USDT using the BTC relay on testnet without requiring the BTC to be bridged to BOB.
...
/**
* @title HelloBitcoin
* @dev contract allows swapping between BTC->USDT using the BTC relay on testnet.
