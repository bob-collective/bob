...
- FPs prioritized based on BOB token delegations and ecosystem contributions
...
- **Delegation**: Non-custodial smart contracts where nodes cannot access delegated BOB tokens
