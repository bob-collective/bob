...
<Tip>
Display `quote.fee`, `quote.estimatedTimeInSecs`, and other quote fields to give users transparency about the transaction.
</Tip>
...
if ('onramp' in quote) {
  ...
  console.log('Fees:', quote.layerZero.feeBreakdown);
