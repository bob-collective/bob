...
const gatewaySDK = new GatewaySDK(undefined, 'your-66-character-api-key');
```

The API key must be exactly 66 characters long. When provided, the SDK will include it in the `Authorization` header as a Bearer token.
