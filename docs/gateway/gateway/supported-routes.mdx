...
Live data from the [`/v1/get-routes`](/api-reference/overview) endpoint, with token symbols resolved from the [BOB tokenlist](https://github.com/bob-collective/bob/blob/master/tokenlist/tokenlist.json).
