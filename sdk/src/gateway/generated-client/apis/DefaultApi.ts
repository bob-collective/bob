...
export class DefaultApi extends runtime.BaseAPI {
    ...
    ): Promise<runtime.ApiResponse<Array<GatewayChain>>> {
    ...
    async getOrdersRaw(
        ...
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<Array<GatewayOrderInfo>>> {
    ...
    async getQuoteRaw(
        ...
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<GatewayQuote>> {
     ...
     */
    async getReferralsRaw(
        requestParameters: GetReferralsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<ReferralInfo>> {
        if (requestParameters['userAddress'] == null) {
            throw new runtime.RequiredError(
                'userAddress',
    ...
    async getRoutesRaw(
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<Array<RouteInfo>>> {
        const queryParameters: any = {};
     ...
     */
    async registerBtcTxRaw(
        requestParameters: RegisterBtcTxRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
     ...
     * Start a new onramp.
     */
    async startOnrampRaw(
        requestParameters: StartOnrampRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<GatewayCreateOnramp>> {
