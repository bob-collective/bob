...
All URIs are relative to *https://gateway-api-staging.gobob.xyz*
...
async function example() {
  ...
  const body = {
    ...
    dstChain: bob,
    // string | Address sending the funds
...
| **sender** | `string` | Address sending the funds | [Defaults to `undefined`] |
