...
export class DeterministicDeployer {
  ...
  static proxyAddress = '0x9607Fe42F3f1b88b26178a3103653F3dCFf5D5be';
  static deploymentTransaction =
    '';
  static deploymentSignerAddress = '0x09A72fd4b10948160aD64A4AD8802Ce67831A3F2';
  static deploymentGasPrice = 100000000000;
  static deploymentGasLimit = 100000;

  constructor(readonly provider: JsonRpcProvider, readonly signer?: Signer) {}
  ...
  static getDeterministicDeployAddress(
    ...
    return (
      '0x' +
      keccak256(hexConcat(['0xff', DeterministicDeployer.proxyAddress, saltEncoded, keccak256(ctrCode1)])).slice(-40)
    );
  }
