...
```*/
    ...
    pub struct getDepositInfoReturn {
        pub info: <DepositInfo as alloy::sol_types::SolType>::RustType,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        ...
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> = (DepositInfo,);
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <DepositInfo as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
        ...
        impl alloy_sol_types::SolCall for getDepositInfoCall {
            ...
            type ReturnTuple<'a> = (DepositInfo,);
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
...
```*/
    ...
    ///Container for all the [`IStakeManager`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IStakeManagerCalls {
        const NAME: &'static str = "IStakeManagerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IStakeManagerCalls>] = &[
                {
                    fn addStake(
                        data: &[u8],
                        validate: bool,
                        ...
                        <addStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStakeManagerCalls::addStake)
                    }
                    addStake
                },
                {
                    fn withdrawTo(
                        ...
                        <withdrawToCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStakeManagerCalls::withdrawTo)
                    }
                    withdrawTo
                },
                {
                    fn getDepositInfo(
                        ...
                        <getDepositInfoCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStakeManagerCalls::getDepositInfo)
                    }
                    getDepositInfo
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStakeManagerCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn depositTo(
                        ...
                        <depositToCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStakeManagerCalls::depositTo)
                    }
                    depositTo
                },
                {
                    fn unlockStake(
                        ...
                        <unlockStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStakeManagerCalls::unlockStake)
                    }
                    unlockStake
                },
                {
                    fn withdrawStake(
                        ...
                        <withdrawStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStakeManagerCalls::withdrawStake)
                    }
                    withdrawStake
                },
            ];
    ...
    ///Container for all the [`IStakeManager`](self) events.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IStakeManagerEvents {
        const NAME: &'static str = "IStakeManagerEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IStakeManagerEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IStakeManagerInstance<T, P, N>>,
    > {
        IStakeManagerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IStakeManagerInstance::<T, P, N>::deploy_builder(provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IStakeManagerInstance<T, P, N>> {
