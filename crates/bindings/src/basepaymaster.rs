...
```*/
    ...
    ///Container for all the [`BasePaymaster`](self) function calls.
    pub enum BasePaymasterCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for BasePaymasterCalls {
        const NAME: &'static str = "BasePaymasterCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<BasePaymasterCalls>] = &[
                {
                    fn addStake(
                        data: &[u8],
                        validate: bool,
                        ...
                        <addStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::addStake)
                    }
                    addStake
                },
                {
                    fn withdrawTo(
                        ...
                        <withdrawToCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::withdrawTo)
                    }
                    withdrawTo
                },
                {
                    fn renounceOwnership(
                        ...
                        <renounceOwnershipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::renounceOwnership)
                    }
                    renounceOwnership
                },
                {
                ...
                },
                {
                    fn entryPoint(
                        ...
                        <entryPointCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::entryPoint)
                    }
                    entryPoint
                },
                {
                    fn unlockStake(
                        ...
                        <unlockStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::unlockStake)
                    }
                    unlockStake
                },
                {
                    fn withdrawStake(
                        ...
                        <withdrawStakeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::withdrawStake)
                    }
                    withdrawStake
                },
                {
                    fn getDeposit(
                        ...
                        <getDepositCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::getDeposit)
                    }
                    getDeposit
                },
                {
                    fn deposit(
                        ...
                        <depositCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::deposit)
                    }
                    deposit
                },
                {
                    fn transferOwnership(
                        ...
                        <transferOwnershipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::transferOwnership)
                    }
                    transferOwnership
                },
                {
                    fn validatePaymasterUserOp(
                        ...
                        <validatePaymasterUserOpCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BasePaymasterCalls::validatePaymasterUserOp)
                    }
    ...
    ///Container for all the [`BasePaymaster`](self) events.
    pub enum BasePaymasterEvents {
        OwnershipTransferred(OwnershipTransferred),
    }
    #[automatically_derived]
    impl BasePaymasterEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BasePaymasterEvents {
        const NAME: &'static str = "BasePaymasterEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BasePaymasterEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`BasePaymaster`](self) contract instance.

See the [wrapper's documentation](`BasePaymasterInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> BasePaymasterInstance<T, P, N> {
        BasePaymasterInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<BasePaymasterInstance<T, P, N>>,
    > {
        BasePaymasterInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        BasePaymasterInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`BasePaymaster`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`BasePaymaster`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BasePaymasterInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for BasePaymasterInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BasePaymasterInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<BasePaymasterInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> BasePaymasterInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BasePaymasterInstance<T, P, N> {
