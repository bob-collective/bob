...
```*/
    ...
    impl IStrategyCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[80u8, 99u8, 76u8, 14u8]];
    }
    #[automatically_derived]
            ...
            ) -> alloy_sol_types::Result<IStrategyCalls>] = &[
                {
                    fn handleGatewayMessage(
                        ...
                        <handleGatewayMessageCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStrategyCalls::handleGatewayMessage)
                    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IStrategyInstance<P, N>>,
    > {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IStrategyInstance<P, N>> {
