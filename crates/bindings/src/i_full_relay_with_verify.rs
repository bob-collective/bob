...
```*/
    ...
    impl IFullRelayWithVerifyCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(verifyHeaderHash),
        ];
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <verifyHeaderHashCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`IFullRelayWithVerifyInstance`) for more details.*/
    ...
    >(
        ...
        IFullRelayWithVerifyInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IFullRelayWithVerifyInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IFullRelayWithVerifyInstance::<P, N>::deploy_builder(__provider)
    }
