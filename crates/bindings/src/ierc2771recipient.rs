...
```*/
    ...
    ///Container for all the [`IERC2771Recipient`](self) function calls.
    pub enum IERC2771RecipientCalls {
        isTrustedForwarder(isTrustedForwarderCall),
    }
    #[automatically_derived]
    impl IERC2771RecipientCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[87u8, 43u8, 108u8, 5u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC2771RecipientCalls {
        const NAME: &'static str = "IERC2771RecipientCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC2771RecipientCalls>] = &[
                {
                    fn isTrustedForwarder(
                        ...
                        <isTrustedForwarderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC2771RecipientCalls::isTrustedForwarder)
                    }
                    isTrustedForwarder
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IERC2771Recipient`](self) contract instance.

See the [wrapper's documentation](`IERC2771RecipientInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC2771RecipientInstance<T, P, N> {
        IERC2771RecipientInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC2771RecipientInstance<T, P, N>>,
    > {
        IERC2771RecipientInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC2771RecipientInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC2771Recipient`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC2771Recipient`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC2771RecipientInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC2771RecipientInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC2771RecipientInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC2771RecipientInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC2771RecipientInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC2771RecipientInstance<T, P, N> {
