...
pub mod FullRelayHeaviestFromAncestorWithRetargetTest {
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<testHandlingDescendantsAtDifferentDifficultyPeriodCall>
                for UnderlyingRustTuple<'_>
            {
                fn from(value: testHandlingDescendantsAtDifferentDifficultyPeriodCall) -> Self {
                    ()
                }
            }
            #[automatically_derived]
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<testHandlingDescendantsAtDifferentDifficultyPeriodReturn>
                for UnderlyingRustTuple<'_>
            {
                fn from(value: testHandlingDescendantsAtDifferentDifficultyPeriodReturn) -> Self {
                    ()
                }
            }
            #[automatically_derived]
        ...
        #[automatically_derived]
        impl alloy_sol_types::SolCall for testHandlingDescendantsAtDifferentDifficultyPeriodCall {
            type Parameters<'a> = ();
            type Token<'a> = <Self::Parameters<'a> as alloy_sol_types::SolType>::Token<'a>;
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for FullRelayHeaviestFromAncestorWithRetargetTestCalls {
            ...
            >] = &[
                {
                    fn getHeaderHexes(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        <getHeaderHexesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            data, validate,
                        )
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::getHeaderHexes)
                    }
                    getHeaderHexes
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        <getHeadersCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::getHeaders)
                    }
                    getHeaders
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::excludeSenders)
                    }
                    excludeSenders
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::targetInterfaces)
                    }
                    targetInterfaces
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::targetSenders)
                    }
                    targetSenders
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::targetContracts)
                    }
                    targetContracts
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::getDigestLes)
                    }
                    getDigestLes
                },
                {
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::targetArtifacts)
                    }
                    targetArtifacts
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::targetSelectors)
                    }
                    targetSelectors
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::excludeArtifacts)
                    }
                    excludeArtifacts
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        <failedCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::failed)
                    }
                    failed
                },
                {
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::excludeContracts)
                    }
                    excludeContracts
                },
                {
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        <IS_TESTCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::IS_TEST)
                    }
                    IS_TEST
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<FullRelayHeaviestFromAncestorWithRetargetTestCalls>
                    {
                        ...
                        .map(FullRelayHeaviestFromAncestorWithRetargetTestCalls::getBlockHeights)
                    }
                    getBlockHeights
                },
            ];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for FullRelayHeaviestFromAncestorWithRetargetTestEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for FullRelayHeaviestFromAncestorWithRetargetTestEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    >(
        ...
        FullRelayHeaviestFromAncestorWithRetargetTestInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        ...
        >,
    > {
        FullRelayHeaviestFromAncestorWithRetargetTestInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        FullRelayHeaviestFromAncestorWithRetargetTestInstance::<T, P, N>::deploy_builder(provider)
    }
        ...
        > FullRelayHeaviestFromAncestorWithRetargetTestInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<FullRelayHeaviestFromAncestorWithRetargetTestInstance<T, P, N>>
        {
        ...
        > FullRelayHeaviestFromAncestorWithRetargetTestInstance<T, P, N>
    {
        ...
        pub fn testHandlingDescendantsWhenBothAtDifferentNewDifficultyPeriod(
            ...
            N,
        > {
            self.call_builder(&testHandlingDescendantsWhenBothAtDifferentNewDifficultyPeriodCall {})
        }
    }
    /// Event filters.
    #[automatically_derived]
