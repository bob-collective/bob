...
interface ForkedStrategyTemplateTbtc {
    event log(string);
...
pub mod ForkedStrategyTemplateTbtc {
    use super::*;
    use alloy::sol_types as alloy_sol_types;
...
```*/
    ...
    ///Container for all the [`ForkedStrategyTemplateTbtc`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum ForkedStrategyTemplateTbtcCalls {
        #[allow(missing_docs)]
        IS_TEST(IS_TESTCall),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl ForkedStrategyTemplateTbtcCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ForkedStrategyTemplateTbtcCalls {
        const NAME: &'static str = "ForkedStrategyTemplateTbtcCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ForkedStrategyTemplateTbtcCalls>] = &[
                {
                    fn excludeSenders(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<ForkedStrategyTemplateTbtcCalls> {
                        <excludeSendersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::excludeSenders)
                    }
                    excludeSenders
                },
                {
                    fn targetInterfaces(
                        ...
                        <targetInterfacesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::targetInterfaces)
                    }
                    targetInterfaces
                },
                {
                    fn targetSenders(
                        ...
                        <targetSendersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::targetSenders)
                    }
                    targetSenders
                },
                {
                    fn targetContracts(
                        ...
                        <targetContractsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::targetContracts)
                    }
                    targetContracts
                },
                {
                    fn targetArtifactSelectors(
                        ...
                        <targetArtifactSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                ForkedStrategyTemplateTbtcCalls::targetArtifactSelectors,
                            )
                    }
                ...
                },
                {
                    fn targetArtifacts(
                        ...
                        <targetArtifactsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::targetArtifacts)
                    }
                    targetArtifacts
                },
                {
                    fn targetSelectors(
                        ...
                        <targetSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::targetSelectors)
                    }
                    targetSelectors
                },
                {
                    fn excludeSelectors(
                        ...
                        <excludeSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::excludeSelectors)
                    }
                    excludeSelectors
                },
                {
                    fn excludeArtifacts(
                        ...
                        <excludeArtifactsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::excludeArtifacts)
                    }
                    excludeArtifacts
                },
                {
                    fn failed(
                        ...
                        <failedCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ForkedStrategyTemplateTbtcCalls::failed)
                    }
                    failed
                },
                {
                    fn excludeContracts(
                        ...
                        <excludeContractsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ForkedStrategyTemplateTbtcCalls::excludeContracts)
                    }
                    excludeContracts
                },
                {
                    fn simulateForkAndTransfer(
                        ...
                        <simulateForkAndTransferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                ForkedStrategyTemplateTbtcCalls::simulateForkAndTransfer,
                            )
                    }
                ...
                },
                {
                    fn IS_TEST(
                        ...
                        <IS_TESTCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ForkedStrategyTemplateTbtcCalls::IS_TEST)
                    }
                    IS_TEST
                },
                {
                    fn token(
                        ...
                        <tokenCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ForkedStrategyTemplateTbtcCalls::token)
                    }
                    token
                },
            ];
    ...
    ///Container for all the [`ForkedStrategyTemplateTbtc`](self) events.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum ForkedStrategyTemplateTbtcEvents {
        #[allow(missing_docs)]
        log(log),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl ForkedStrategyTemplateTbtcEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ForkedStrategyTemplateTbtcEvents {
        const NAME: &'static str = "ForkedStrategyTemplateTbtcEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ForkedStrategyTemplateTbtcEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::log(inner) => {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ForkedStrategyTemplateTbtc`](self) contract instance.

See the [wrapper's documentation](`ForkedStrategyTemplateTbtcInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ForkedStrategyTemplateTbtcInstance<P, N> {
        ForkedStrategyTemplateTbtcInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ForkedStrategyTemplateTbtcInstance<P, N>>,
    > {
        ForkedStrategyTemplateTbtcInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ForkedStrategyTemplateTbtcInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`ForkedStrategyTemplateTbtc`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ForkedStrategyTemplateTbtc`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ForkedStrategyTemplateTbtcInstance<
        P,
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ForkedStrategyTemplateTbtcInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ForkedStrategyTemplateTbtcInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ForkedStrategyTemplateTbtcInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ForkedStrategyTemplateTbtcInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ForkedStrategyTemplateTbtcInstance<P, N> {
            ForkedStrategyTemplateTbtcInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
