...
```*/
    ...
    ///Container for all the [`ERC20Burnable`](self) function calls.
    pub enum ERC20BurnableCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC20BurnableCalls {
        const NAME: &'static str = "ERC20BurnableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ERC20BurnableCalls>] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::approve)
                    }
                    approve
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn decimals(
                        ...
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::decimals)
                    }
                    decimals
                },
                {
                    fn increaseAllowance(
                        ...
                        <increaseAllowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::increaseAllowance)
                    }
                    increaseAllowance
                },
                {
                ...
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn burnFrom(
                        ...
                        <burnFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::burnFrom)
                    }
                    burnFrom
                },
                {
                ...
                },
                {
                    fn decreaseAllowance(
                        ...
                        <decreaseAllowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::decreaseAllowance)
                    }
                    decreaseAllowance
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::transfer)
                    }
                    transfer
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableCalls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`ERC20Burnable`](self) events.
    pub enum ERC20BurnableEvents {
        Approval(Approval),
        Transfer(Transfer),
    }
    #[automatically_derived]
    impl ERC20BurnableEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC20BurnableEvents {
        const NAME: &'static str = "ERC20BurnableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC20BurnableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`ERC20Burnable`](self) contract instance.

See the [wrapper's documentation](`ERC20BurnableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC20BurnableInstance<T, P, N> {
        ERC20BurnableInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC20BurnableInstance<T, P, N>>,
    > {
        ERC20BurnableInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ERC20BurnableInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ERC20Burnable`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC20Burnable`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC20BurnableInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ERC20BurnableInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC20BurnableInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC20BurnableInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ERC20BurnableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC20BurnableInstance<T, P, N> {
