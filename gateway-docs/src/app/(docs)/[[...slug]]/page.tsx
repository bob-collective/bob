...
export default async function Page(props: PageProps<'/[[...slug]]'>) {
  ...
  // Pages generated from the OpenAPI spec render <OpenAPIPage />, which needs
  // the bundled schema handed to it. Everything else skips this entirely.
  const preloaded = '_openapi' in page.data ? await openapi.preloadOpenAPIPage(page) : undefined;
